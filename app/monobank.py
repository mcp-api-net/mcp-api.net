...
def create_invoice(
    ...
    payload: dict = {
        ...
        "paymentType": "debit",
        # validity
        # Строк дії в секундах, за замовчуванням рахунок перестає бути дійсним через 24 години. Максимальний термін життя інвойса який можна задати
        # - 30 днів. Якщо передати понад 30 днів, то автоматично обрізається до 30 днів 7 days:
        "validity": 7 * 24 * 60 * 60,
    }
